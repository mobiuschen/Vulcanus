package im.mobius.debug
{
    ...
    {
        static public const SEPARATOR:String = "&&\n";
         ...
         * 
         */    
        public function createLog(type:String, msg:String):int
        {
            if(type == null || type == "")
            {
         ...
         * 
         */        
        public function getLogByIndex(index:uint):LogEntity
        {
            if(_allLogs == null || index < 0 || index >= _allLogs.length)
                return null;
            return _allLogs[index];
        }
